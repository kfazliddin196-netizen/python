...
l=Listbox(width=35,height=15,bg='red',fg='black')
l.place(x=200,y=100)
b=Listbox(width=65,height=15,bg='red',fg='black')
b.place(x=450,y=100)
p=Listbox(width=70,height=13,bg='red',listvariable=expression)
p.place(x=355,y=450,)
d1=StringVar(value='Menyu')
c=ttk.Combobox(values=m,textvariable=d1)
c.place(anchor=NW,x=6,y=35)
d=ttk.Button(width=15,text='Qidiruv',command=R)
d.place(x=455,y=6)
d2=ttk.Button(width=20,text=' Tanlash',command=O)
d2.place(x=160,y=35)
...
h.place(x=200,y=490)
k=ttk.Button(width=20,text='Sotib olish',command=V1)
k.place(x=200,y=600)
e10=ttk.Entry()
